...
% Description: within 20 neurons (5E-5I, intra(E-I & I-E), inter (I-E))
...
% Synaptic connection:(GDL-A27h-GDL)
  ...
  E3_I_igaba_gSYN = +0.2500; E3_I_igaba_ESYN = -80.0000;
  E3_I_igaba_tauD = +10.0000; E3_I_igaba_tauR = +0.4000;
  E3_I4_igaba_gSYN = +0.2500; E3_I4_igaba_ESYN = -80.0000;
  E3_I4_igaba_tauD = +10.0000; E3_I4_igaba_tauR = +0.4000;
  E5_I4_igaba_gSYN = +0.2500; E5_I4_igaba_ESYN = -80.0000;
  E5_I4_igaba_tauD = +10.0000; E5_I4_igaba_tauR = +0.4000; 
  E5_I6_igaba_gSYN = +0.2500; E5_I6_igaba_ESYN = -80.0000;
  E5_I6_igaba_tauD = +10.0000; E5_I6_igaba_tauR = +0.4000;
  E7_I6_igaba_gSYN = +0.2500; E7_I6_igaba_ESYN = -80.0000;
  E7_I6_igaba_tauD = +10.0000; E7_I6_igaba_tauR = +0.4000;
  E7_I8_igaba_gSYN = +0.2500; E7_I8_igaba_ESYN = -80.0000;
  E7_I8_igaba_tauD = +10.0000; E7_I8_igaba_tauR = +0.4000;
  E9_I8_igaba_gSYN = +0.2500; E9_I8_igaba_ESYN = -80.0000;
  E9_I8_igaba_tauD = +10.0000; E9_I8_igaba_tauR = +0.4000;
  E9_I10_igaba_gSYN = +0.2500; E9_I10_igaba_ESYN = -80.0000;
  E9_I10_igaba_tauD = +10.0000; E9_I10_igaba_tauR = +0.4000;
  E_I10_igaba_gSYN = +0.2500; E_I10_igaba_ESYN = -80.0000;
  E_I10_igaba_tauD = +10.0000; E_I10_igaba_tauR = +0.4000;
...
% Neuron population setting:
  ...
  E3_I_igaba_netcon = ones(I_Npop,E3_Npop);
  E3_I4_igaba_netcon = ones(I4_Npop,E3_Npop);
  E5_I4_igaba_netcon = ones(I4_Npop,E5_Npop);
  E5_I6_igaba_netcon = ones(I6_Npop,E5_Npop);
  E7_I6_igaba_netcon = ones(I6_Npop,E7_Npop);
  E7_I8_igaba_netcon = ones(I8_Npop,E7_Npop);
  E9_I8_igaba_netcon = ones(I8_Npop,E9_Npop);
  E9_I10_igaba_netcon = ones(I10_Npop,E9_Npop);
  E_I10_igaba_netcon = ones(I10_Npop,E_Npop);
  % with E-I intra connection
...
%% Functions:
  ...
  E3_I_igaba_ISYN = @(E3_v,E3_I_igaba_s)(E3_I_igaba_gSYN.*(E3_I_igaba_s*E3_I_igaba_netcon).*(E3_v-E3_I_igaba_ESYN));
  E3_I4_igaba_ISYN = @(E3_v,E3_I4_igaba_s)(E3_I4_igaba_gSYN.*(E3_I4_igaba_s*E3_I4_igaba_netcon).*(E3_v-E3_I4_igaba_ESYN)); 
  E5_I4_igaba_ISYN = @(E5_v,E5_I4_igaba_s)(E5_I4_igaba_gSYN.*(E5_I4_igaba_s*E5_I4_igaba_netcon).*(E5_v-E5_I4_igaba_ESYN)); 
  E5_I6_igaba_ISYN = @(E5_v,E5_I6_igaba_s)(E5_I6_igaba_gSYN.*(E5_I6_igaba_s*E5_I6_igaba_netcon).*(E5_v-E5_I6_igaba_ESYN));
  E7_I6_igaba_ISYN = @(E7_v,E7_I6_igaba_s)(E7_I6_igaba_gSYN.*(E7_I6_igaba_s*E7_I6_igaba_netcon).*(E7_v-E7_I6_igaba_ESYN));
  E7_I8_igaba_ISYN = @(E7_v,E7_I8_igaba_s)(E7_I8_igaba_gSYN.*(E7_I8_igaba_s*E7_I8_igaba_netcon).*(E7_v-E7_I8_igaba_ESYN));
  E9_I8_igaba_ISYN = @(E9_v,E9_I8_igaba_s)(E9_I8_igaba_gSYN.*(E9_I8_igaba_s*E9_I8_igaba_netcon).*(E9_v-E9_I8_igaba_ESYN));
  E9_I10_igaba_ISYN = @(E9_v,E9_I10_igaba_s)(E9_I10_igaba_gSYN.*(E9_I10_igaba_s*E9_I10_igaba_netcon).*(E9_v-E9_I10_igaba_ESYN));
  E_I10_igaba_ISYN = @(E_v,E_I10_igaba_s)(E_I10_igaba_gSYN.*(E_I10_igaba_s*E_I10_igaba_netcon).*(E_v-E_I10_igaba_ESYN));
  % with E-I intra connection
...
ODEFUN = @(t,X)[((5+0*randn(1,1)))+((E_ina_INa(X(1:1)',X(2:2)',X(3:3)'))+((E_ik_IK(X(1:1)',X(4:4)'))))+((-E_I_igaba_ISYN(X(1:1)',X(41:41)')))+((-E_I10_igaba_ISYN(X(1:1)',X(50:50)'))),...
    ...
    ((5+0*randn(1,1)))+((((E3_ina_INa(X(9:9)',X(10:10)',X(11:11)'))+((E3_ik_IK(X(9:9)',X(12:12)'))))))+((-E3_I4_igaba_ISYN(X(9:9)',X(43:43)')))+((-E3_I_igaba_ISYN(X(9:9)',X(42:42)'))),...
    ...
    ((5+0*randn(1,1)))+((((E5_ina_INa(X(17:17)',X(18:18)',X(19:19)'))+((E5_ik_IK(X(17:17)',X(20:20)'))))))+((-E5_I6_igaba_ISYN(X(17:17)',X(45:45)')))+((-E5_I4_igaba_ISYN(X(17:17)',X(44:44)'))),...
    ...
    ((5+0*randn(1,1)))+((((E7_ina_INa(X(25:25)',X(26:26)',X(27:27)'))+((E7_ik_IK(X(25:25)',X(28:28)'))))))+((-E7_I8_igaba_ISYN(X(25:25)',X(47:47)')))+((-E7_I6_igaba_ISYN(X(25:25)',X(46:46)'))),...
    ...
    ((5+0*randn(1,1)))+((((E9_ina_INa(X(33:33)',X(34:34)',X(35:35)'))+((E9_ik_IK(X(33:33)',X(36:36)'))))))+((-E9_I10_igaba_ISYN(X(33:33)',X(49:49)')))+((-E9_I8_igaba_ISYN(X(33:33)',X(48:48)'))),...
