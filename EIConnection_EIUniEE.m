...
% Description: within 20 neurons (5E-5I, intra(E-I & I-E), inter (E-E))
...
% Synaptic connection:(GDL-A27h-GDL)
  ...
  E3_E_iampa_gSYN = +0.1000; E3_E_iampa_ESYN = +0.0000;
  E3_E_iampa_tauD = +2.0000; E3_E_iampa_tauR = +0.4000;
  E3_I4_igaba_gSYN = +0.2500; E3_I4_igaba_ESYN = -80.0000;
  E3_I4_igaba_tauD = +10.0000; E3_I4_igaba_tauR = +0.4000;
  E5_E3_iampa_gSYN = +0.1000; E5_E3_iampa_ESYN = +0.0000;
  E5_E3_iampa_tauD = +2.0000; E5_E3_iampa_tauR = +0.4000;  
  E5_I6_igaba_gSYN = +0.2500; E5_I6_igaba_ESYN = -80.0000;
  E5_I6_igaba_tauD = +10.0000; E5_I6_igaba_tauR = +0.4000;
  E7_E5_iampa_gSYN = +0.1000; E7_E5_iampa_ESYN = +0.0000;
  E7_E5_iampa_tauD = +2.0000; E7_E5_iampa_tauR = +0.4000;
  E7_I8_igaba_gSYN = +0.2500; E7_I8_igaba_ESYN = -80.0000;
  E7_I8_igaba_tauD = +10.0000; E7_I8_igaba_tauR = +0.4000;
  E9_E7_iampa_gSYN = +0.1000; E9_E7_iampa_ESYN = +0.0000;
  E9_E7_iampa_tauD = +2.0000; E9_E7_iampa_tauR = +0.4000; 
  E9_I10_igaba_gSYN = +0.2500; E9_I10_igaba_ESYN = -80.0000;
  E9_I10_igaba_tauD = +10.0000; E9_I10_igaba_tauR = +0.4000;
  E_E9_iampa_gSYN = +0.1000; E_E9_iampa_ESYN = +0.0000;
  E_E9_iampa_tauD = +2.0000; E_E9_iampa_tauR = +0.4000;
...
% Neuron population setting:
  ...
  E3_E_iampa_netcon = ones(E_Npop,E3_Npop);
  E3_I4_igaba_netcon = ones(I4_Npop,E3_Npop);
  E5_E3_iampa_netcon = ones(E3_Npop,E5_Npop);
  E5_I6_igaba_netcon = ones(I6_Npop,E5_Npop);
  E7_E5_iampa_netcon = ones(E5_Npop,E7_Npop);
  E7_I8_igaba_netcon = ones(I8_Npop,E7_Npop);
  E9_E7_iampa_netcon = ones(E7_Npop,E9_Npop);
  E9_I10_igaba_netcon = ones(I10_Npop,E9_Npop);
  E_E9_iampa_netcon = ones(E9_Npop,E_Npop);
  % with E-I intra connection
...
%% Functions:
  ...
  E3_E_iampa_ISYN = @(E3_v,E3_E_iampa_s)(E3_E_iampa_gSYN.*(E3_E_iampa_s*E3_E_iampa_netcon).*(E3_v-E3_E_iampa_ESYN));
  E3_I4_igaba_ISYN = @(E3_v,E3_I4_igaba_s)(E3_I4_igaba_gSYN.*(E3_I4_igaba_s*E3_I4_igaba_netcon).*(E3_v-E3_I4_igaba_ESYN)); 
  E5_E3_iampa_ISYN = @(E5_v,E5_E3_iampa_s)(E5_E3_iampa_gSYN.*(E5_E3_iampa_s*E5_E3_iampa_netcon).*(E5_v-E5_E3_iampa_ESYN));  
  E5_I6_igaba_ISYN = @(E5_v,E5_I6_igaba_s)(E5_I6_igaba_gSYN.*(E5_I6_igaba_s*E5_I6_igaba_netcon).*(E5_v-E5_I6_igaba_ESYN));
  E7_E5_iampa_ISYN = @(E7_v,E7_E5_iampa_s)(E7_E5_iampa_gSYN.*(E7_E5_iampa_s*E7_E5_iampa_netcon).*(E7_v-E7_E5_iampa_ESYN));
  E7_I8_igaba_ISYN = @(E7_v,E7_I8_igaba_s)(E7_I8_igaba_gSYN.*(E7_I8_igaba_s*E7_I8_igaba_netcon).*(E7_v-E7_I8_igaba_ESYN));
  E9_E7_iampa_ISYN = @(E9_v,E9_E7_iampa_s)(E9_E7_iampa_gSYN.*(E9_E7_iampa_s*E9_E7_iampa_netcon).*(E9_v-E9_E7_iampa_ESYN)); 
  E9_I10_igaba_ISYN = @(E9_v,E9_I10_igaba_s)(E9_I10_igaba_gSYN.*(E9_I10_igaba_s*E9_I10_igaba_netcon).*(E9_v-E9_I10_igaba_ESYN));
  E_E9_iampa_ISYN = @(E_v,E_E9_iampa_s)(E_E9_iampa_gSYN.*(E_E9_iampa_s*E_E9_iampa_netcon).*(E_v-E_E9_iampa_ESYN));
  % with E-I intra connection
...
ODEFUN = @(t,X)[((5+0*randn(1,1)))+((E_ina_INa(X(1:1)',X(2:2)',X(3:3)'))+((E_ik_IK(X(1:1)',X(4:4)'))))+((-E_I_igaba_ISYN(X(1:1)',X(41:41)')))+(-E_E9_iampa_ISYN(X(1:1)',X(50:50)')),...
    ...
    ((0+0*randn(1,1)))+((I_ina_INa(X(5:5)',X(6:6)',X(7:7)'))+((I_ik_IK(X(5:5)',X(8:8)'))))+(-I_E_iampa_ISYN(X(5:5)',X(51:51)')),...
    ...
    ((5+0*randn(1,1)))+((((E3_ina_INa(X(9:9)',X(10:10)',X(11:11)'))+((E3_ik_IK(X(9:9)',X(12:12)'))))))+((-E3_I4_igaba_ISYN(X(9:9)',X(43:43)')))+(-E3_E_iampa_ISYN(X(9:9)',X(42:42)')),...
    ...
    ((0+0*randn(1,1)))+((((I4_ina_INa(X(13:13)',X(14:14)',X(15:15)'))+((I4_ik_IK(X(13:13)',X(16:16)'))))))+(-I4_E3_iampa_ISYN(X(13:13)',X(52:52)')),...
    ...
    ((5+0*randn(1,1)))+((((E5_ina_INa(X(17:17)',X(18:18)',X(19:19)'))+((E5_ik_IK(X(17:17)',X(20:20)'))))))+((-E5_I6_igaba_ISYN(X(17:17)',X(45:45)')))+(-E5_E3_iampa_ISYN(X(17:17)',X(44:44)')),...
    ...
    ((0+0*randn(1,1)))+((((I6_ina_INa(X(21:21)',X(22:22)',X(23:23)'))+((I6_ik_IK(X(21:21)',X(24:24)'))))))+(-I6_E5_iampa_ISYN(X(21:21)',X(53:53)')),...
    ...
    ((5+0*randn(1,1)))+((((E7_ina_INa(X(25:25)',X(26:26)',X(27:27)'))+((E7_ik_IK(X(25:25)',X(28:28)'))))))+((-E7_I8_igaba_ISYN(X(25:25)',X(47:47)')))+(-E7_E5_iampa_ISYN(X(25:25)',X(46:46)')),...
    ...
    ((0+0*randn(1,1)))+((((I8_ina_INa(X(29:29)',X(30:30)',X(31:31)'))+((I8_ik_IK(X(29:29)',X(32:32)'))))))+(-I8_E7_iampa_ISYN(X(29:29)',X(54:54)')),...
    ...
    ((5+0*randn(1,1)))+((((E9_ina_INa(X(33:33)',X(34:34)',X(35:35)'))+((E9_ik_IK(X(33:33)',X(36:36)'))))))+((-E9_I10_igaba_ISYN(X(33:33)',X(49:49)')))+(-E9_E7_iampa_ISYN(X(33:33)',X(48:48)')),...
    ...
    ((0+0*randn(1,1)))+((((I10_ina_INa(X(37:37)',X(38:38)',X(39:39)'))+((I10_ik_IK(X(37:37)',X(40:40)'))))))+(-I10_E9_iampa_ISYN(X(37:37)',X(55:55)')),...
    ...
    -X(42:42)'./2+((1-X(42:42)')/0.4).*(1+tanh(X(1:1)'/10)),...
    -X(43:43)'./10+((1-X(43:43)')/0.4).*(1+tanh(X(13:13)'/10)),...
    -X(44:44)'./2+((1-X(44:44)')/0.4).*(1+tanh(X(9:9)'/10)),...
    -X(45:45)'./10+((1-X(45:45)')/0.4).*(1+tanh(X(21:21)'/10)),...
    -X(46:46)'./2+((1-X(46:46)')/0.4).*(1+tanh(X(17:17)'/10)),...
    -X(47:47)'./10+((1-X(47:47)')/0.4).*(1+tanh(X(29:29)'/10)),...
    -X(48:48)'./2+((1-X(48:48)')/0.4).*(1+tanh(X(25:25)'/10)),...    
    -X(49:49)'./10+((1-X(49:49)')/0.4).*(1+tanh(X(37:37)'/10)),...
    -X(50:50)'./2+((1-X(50:50)')/0.4).*(1+tanh(X(33:33)'/10)),...
